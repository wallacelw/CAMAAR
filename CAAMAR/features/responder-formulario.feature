...
Funcionalidade: Responder formulário
    ...
    Cenário: Sucesso na resposta de formulário
        ...
        Então O sistema receberá a avaliação
    ...
    Cenário: Falha na autenticação
        ...
        E eu tento etrar na página Avaliação - Nome da Matéria - Semestre
        Então Aparecerá uma mensagem de erro dizendo que não estou logado
    ...
    Cenário: Algum campo está em branco
        ...
        Então O sistema me mostrará um pop-up falando que não respondi algumas perguntas
